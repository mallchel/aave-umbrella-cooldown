...
const upsertWithdrawFlow = `-- name: UpsertWithdrawFlow :exec
...
type UpsertWithdrawFlowParams struct {
	ChainID          int64
	TxHash           string
	LogIndex         int32
	BlockNumber      int64
...
func (q *Queries) UpsertWithdrawFlow(ctx context.Context, arg UpsertWithdrawFlowParams) error {
	_, err := q.db.ExecContext(ctx, upsertWithdrawFlow,
		arg.ChainID,
		arg.TxHash,
		arg.LogIndex,
		arg.BlockNumber,
